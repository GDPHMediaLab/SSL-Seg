...
from lib.data.med_pretrain_transforms import get_simmim_pretrain_transforms, get_vis_transforms
...
class SimMIM3DTrainer(BaseTrainer):
    r"""
    SimMIM3D Autoencoder Trainer
    """
    ...
    def build_dataloader(self):
        if self.dataloader is None:
            ...
            args = self.args
            train_transform = get_simmim_pretrain_transforms(args)
