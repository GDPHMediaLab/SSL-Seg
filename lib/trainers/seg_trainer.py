...
import lib.models
import lib.networks
from lib.utils import SmoothedValue, LayerDecayValueAssigner
from lib.data.med_finetune_treansforms import get_scratch_train_transforms, get_val_transforms, get_post_transforms, get_vis_transforms
...
class SegTrainer(BaseTrainer):
    r"""
    Lung tumor Segmentation Trainer
    """
    ...
    def build_dataloader(self):
        if self.dataloader is None:
            ...
            if args.dataset in ['lung']:
                ...
                #val_transform = get_val_npy_transforms(args)
    ...
    def evaluate(self, epoch=0, niters=0):
        ...
        for i, batch_data in enumerate(val_loader):
            #print(f"start evaluating on the i:{i+1}")
            ...
            print("output_convert",output_convert.size())
            ...
            for metric_name, metric_func in self.metric_funcs.items():
                ...
                metric = metric_func(y_pred=output_convert, y=target_convert, include_background=False)
